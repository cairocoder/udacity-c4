...
export async function createTodo(event: APIGatewayProxyEvent,
    ...
    const todoItem = {
        ...
        //attachmentUrl: `https://${todosStorage.getBucketName()}.s3-us-east-1.amazonaws.com/images/${todoId}.png`,
        ...createTodoRequest
    };
...
export async function generateUploadUrl(event: APIGatewayProxyEvent) {
    ...
    const attachmentUrl = `https://${todosStorage.getBucketName()}.s3.amazonaws.com/images/${todoId}.png`;
